 ...
 */
final class Version20200114161614 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tbl_offer (id INT AUTO_INCREMENT NOT NULL, main_picture_id INT DEFAULT NULL, user_id INT NOT NULL, title VARCHAR(100) NOT NULL, slug VARCHAR(100) NOT NULL, body LONGTEXT NOT NULL, bodyExtract VARCHAR(255) NOT NULL, body_block_picture_count INT NOT NULL, body_block_video_count INT NOT NULL, kind SMALLINT NOT NULL, category SMALLINT NOT NULL, price VARCHAR(20) NOT NULL, raw_price DOUBLE PRECISION NOT NULL, currency VARCHAR(3) NOT NULL, price_suffix VARCHAR(10) DEFAULT NULL, location VARCHAR(100) DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, postalCode VARCHAR(255) DEFAULT NULL, locality VARCHAR(255) DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, geographicalAreas VARCHAR(255) DEFAULT NULL, formattedAdress VARCHAR(255) DEFAULT NULL, publishCount INT NOT NULL, like_count INT NOT NULL, watch_count INT NOT NULL, comment_count INT NOT NULL, view_count INT NOT NULL, is_draft TINYINT(1) NOT NULL, visibility INT NOT NULL, created_at DATETIME NOT NULL, changed_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, is_locked TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_87B2CD21989D9B62 (slug), INDEX IDX_87B2CD21D6BDC9DC (main_picture_id), INDEX IDX_87B2CD21A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tbl_core_user_meta ADD unlisted_offer_offer_count INT NOT NULL, ADD private_offer_count INT DEFAULT NULL, ADD public_offer_count INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tbl_core_user_meta DROP unlisted_offer_offer_count, DROP private_offer_count, DROP public_offer_count');
    }
}
