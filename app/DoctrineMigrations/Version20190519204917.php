 ...
 */
final class Version20190519204917 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tbl_knowledge2_value_application (id INT NOT NULL, data VARCHAR(100) NOT NULL, name VARCHAR(100) NOT NULL, is_addon TINYINT(1) NOT NULL, hostSoftware VARCHAR(100) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tbl_knowledge2_software_value_application ADD CONSTRAINT FK_AF1236CFD7452741 FOREIGN KEY (software_id) REFERENCES tbl_knowledge2_software (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE tbl_knowledge2_software_value_application ADD CONSTRAINT FK_AF1236CF3E030ACD FOREIGN KEY (application_id) REFERENCES tbl_knowledge2_value_application (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE tbl_knowledge2_value_application ADD CONSTRAINT FK_BFA86098BF396750 FOREIGN KEY (id) REFERENCES tbl_knowledge2_value (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tbl_knowledge2_software_value_application DROP FOREIGN KEY FK_AF1236CFD7452741');
        ...
        $this->addSql('ALTER TABLE tbl_knowledge2_software_value_application DROP FOREIGN KEY FK_AF1236CF3E030ACD');
        $this->addSql('DROP TABLE tbl_knowledge2_software');
        $this->addSql('DROP TABLE tbl_knowledge2_software_value_application');
        ...
        $this->addSql('DROP TABLE tbl_knowledge2_value_application');
