...
class AbstractCommand extends Command implements ServiceSubscriberInterface {
    ...
    public static function getSubscribedServices() {
        return array(
            ...
            MailerUtils::class => '?'.MailerUtils::class,
            OfferManager::class => '?'.OfferManager::class,
            PropertyUtils::class => '?'.PropertyUtils::class,
            TextureUtils::class => '?'.TextureUtils::class,
            TypableUtils::class => '?'.TypableUtils::class,
            UserUtils::class => '?'.UserUtils::class,
            VotableUtils::class => '?'.VotableUtils::class,
            WebScreenshotUtils::class => '?'.WebScreenshotUtils::class,
        );
    }
