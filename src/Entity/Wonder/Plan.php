 ...
 * @ORM\Entity(repositoryClass="App\Repository\Wonder\PlanRepository")
...
class Plan extends AbstractWonder implements HtmlBodiedInterface, InspirableInterface {
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Core\Resource", cascade={"persist"})
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Wonder\Plan", mappedBy="inspirations")
	 */
	private $rebounds;
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Wonder\Plan", inversedBy="rebounds", cascade={"persist"})
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Qa\Question", inversedBy="plans", cascade={"persist"})
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Wonder\Creation", mappedBy="plans")
	 */
	private $creations;
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Wonder\Workshop", mappedBy="plans")
	 */
	private $workshops;
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Howto\Howto", mappedBy="plans")
	 */
	private $howtos;
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Workflow\Workflow", mappedBy="plans")
	 */
	private $workflows;
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Knowledge\School", inversedBy="plans", cascade={"persist"})
	...
	public function addResource(\App\Entity\Core\Resource $resource) {
	...
	public function removeResource(\App\Entity\Core\Resource $resource) {
