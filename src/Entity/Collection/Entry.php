 ...
 * 		})
 * @ORM\Entity(repositoryClass="App\Repository\Collection\EntryRepository")
 */
class Entry implements IdentifiableInterface {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="App\Entity\Collection\Collection", inversedBy="entries")
	...
	public function setCollection(\App\Entity\Collection\Collection $collection = null) {
