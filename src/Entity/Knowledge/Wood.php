...
/**
 * App\Entity\Knowledge\Wood
 *
 * @ORM\Table("tbl_knowledge2_wood")
 * @ORM\Entity(repositoryClass="App\Repository\Knowledge\WoodRepository")
 */
class Wood extends AbstractKnowledge {
	...
	public static $FIELD_DEFS = array(
		Wood::FIELD_NAME           => array(Wood::ATTRIB_TYPE => Text::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => true, Wood::ATTRIB_MANDATORY => true, Wood::ATTRIB_CONSTRAINTS => array(array('App\\Validator\\Constraints\\UniqueWood', array('excludedId' => '@getId'))), Wood::ATTRIB_DATA_CONSTRAINTS => array( array('App\\Validator\\Constraints\\OneThing', array('message' => 'N\'indiquez qu\'un seul Nom français par proposition.')))),
		Wood::FIELD_SCIENTIFICNAME => array(Wood::ATTRIB_TYPE => Text::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => true, Wood::ATTRIB_DATA_CONSTRAINTS => array(array('App\\Validator\\Constraints\\OneThing', array('message' => 'N\'indiquez qu\'un seul Nom scientifique par proposition.')))),
		Wood::FIELD_ENGLISHNAME    => array(Wood::ATTRIB_TYPE => Text::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => true, Wood::ATTRIB_DATA_CONSTRAINTS => array(array('App\\Validator\\Constraints\\OneThing', array('message' => 'N\'indiquez qu\'un seul nom anglais par proposition.')))),
		Wood::FIELD_GRAIN          => array(Wood::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => false, Wood::ATTRIB_MANDATORY => true, Wood::ATTRIB_QUALITY => \App\Entity\Core\Picture::QUALITY_HD),
		Wood::FIELD_ENDGRAIN       => array(Wood::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => false, Wood::ATTRIB_QUALITY => \App\Entity\Core\Picture::QUALITY_HD),
		Wood::FIELD_LUMBER         => array(Wood::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => false, Wood::ATTRIB_QUALITY => \App\Entity\Core\Picture::QUALITY_HD),
		Wood::FIELD_TREE           => array(Wood::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => false, Wood::ATTRIB_QUALITY => \App\Entity\Core\Picture::QUALITY_HD),
		Wood::FIELD_LEAF           => array(Wood::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => false, Wood::ATTRIB_QUALITY => \App\Entity\Core\Picture::QUALITY_HD),
		Wood::FIELD_BARK           => array(Wood::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => false, Wood::ATTRIB_QUALITY => \App\Entity\Core\Picture::QUALITY_HD),
		...
		Wood::FIELD_ORIGIN         => array(Wood::ATTRIB_TYPE => Text::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => true, Wood::ATTRIB_DATA_CONSTRAINTS => array(array('App\\Validator\\Constraints\\OneThing', array('message' => 'N\'indiquez qu\'une seule provenance par proposition.'))), Wood::ATTRIB_FILTER_QUERY => '@origin:"%q%"'),
		Wood::FIELD_UTILIZATION    => array(Wood::ATTRIB_TYPE => Text::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => true, Wood::ATTRIB_DATA_CONSTRAINTS => array(array('App\\Validator\\Constraints\\OneThing', array('message' => 'N\'indiquez qu\'une seule utilisation par proposition.'))), Wood::ATTRIB_FILTER_QUERY => '@utilization:"%q%"'),
	...
	/**
	 * @ORM\OneToMany(targetEntity="App\Entity\Knowledge\Wood\Texture", mappedBy="wood", cascade={"all"})
	 */
	private $textures;
	...
	public function addScientificnameValue(\App\Entity\Knowledge\Value\Text $scientificnameValue) {
	...
	public function removeScientificnameValue(\App\Entity\Knowledge\Value\Text $scientificnameValue) {
	...
	public function addEnglishnameValue(\App\Entity\Knowledge\Value\Text $englishnameValue) {
	...
	public function removeEnglishnameValue(\App\Entity\Knowledge\Value\Text $englishnameValue) {
	...
	public function addGrainValue(\App\Entity\Knowledge\Value\Picture $grainValue) {
	...
	public function removeGrainValue(\App\Entity\Knowledge\Value\Picture $grainValue) {
	...
	public function addEndgrainValue(\App\Entity\Knowledge\Value\Picture $endgrainValue) {
	...
	public function removeEndgrainValue(\App\Entity\Knowledge\Value\Picture $endgrainValue) {
	...
	public function addLumberValue(\App\Entity\Knowledge\Value\Picture $lumberValue) {
	...
	public function removeLumberValue(\App\Entity\Knowledge\Value\Picture $lumberValue) {
	...
	public function addTreeValue(\App\Entity\Knowledge\Value\Picture $treeValue) {
	...
	public function removeTreeValue(\App\Entity\Knowledge\Value\Picture $treeValue) {
	...
	public function addLeafValue(\App\Entity\Knowledge\Value\Picture $leafValue) {
	...
	public function removeLeafValue(\App\Entity\Knowledge\Value\Picture $leafValue) {
	...
	public function addBarkValue(\App\Entity\Knowledge\Value\Picture $barkValue) {
	...
	public function removeBarkValue(\App\Entity\Knowledge\Value\Picture $barkValue) {
