...
use App\Entity\Knowledge\Value\Decimal;
...
/**
 * App\Entity\Knowledge\Tool
 *
 * @ORM\Table("tbl_knowledge2_tool")
 * @ORM\Entity(repositoryClass="App\Repository\Knowledge\ToolRepository")
 */
class Tool extends AbstractKnowledge implements ReviewableInterface {
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Knowledge\Value\Pdf", cascade={"all"})
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Knowledge\Value\Decimal", cascade={"all"})
	...
	public function addManualValue(\App\Entity\Knowledge\Value\Pdf $manual) {
	...
	public function removeManualValue(\App\Entity\Knowledge\Value\Pdf $manual) {
	...
	public function addBrandValue(\App\Entity\Knowledge\Value\Text $brand) {
	...
	public function removeBrandValue(\App\Entity\Knowledge\Value\Text $brand) {
	...
	public function addEnglishNameValue(\App\Entity\Knowledge\Value\Text $englishName) {
	...
	public function removeEnglishNameValue(\App\Entity\Knowledge\Value\Text $englishName) {
	...
	public function addProductNameValue(\App\Entity\Knowledge\Value\Text $productName) {
	...
	public function removeProductNameValue(\App\Entity\Knowledge\Value\Text $productName) {
	...
	public function addFamilyValue(\App\Entity\Knowledge\Value\Integer $familyValue) {
	...
	public function removeFamilyValue(\App\Entity\Knowledge\Value\Integer $familyValue) {
	...
	public function addPowerSupplyValue(\App\Entity\Knowledge\Value\Integer $powerSupplyValue) {
	...
	public function removePowerSupplyValue(\App\Entity\Knowledge\Value\Integer $powerSupplyValue) {
	...
	public function addPowerValue(\App\Entity\Knowledge\Value\Integer $powerValue) {
	...
	public function removePowerValue(\App\Entity\Knowledge\Value\Integer $powerValue) {
	...
	public function addVoltageValue(\App\Entity\Knowledge\Value\Integer $voltageValue) {
	...
	public function removeVoltageValue(\App\Entity\Knowledge\Value\Integer $voltageValue) {
	...
	public function addWeightValue(\App\Entity\Knowledge\Value\Decimal $weightValue) {
	...
	public function removeWeightValue(\App\Entity\Knowledge\Value\Decimal $weightValue) {
	...
	public function addUtilizationValue(\App\Entity\Knowledge\Value\Text $utilizationValue) {
	...
	public function removeUtilizationValue(\App\Entity\Knowledge\Value\Text $utilizationValue) {
