...
/**
 * App\Entity\Knowledge\Provider
 *
 * @ORM\Table("tbl_knowledge2_provider")
 * @ORM\Entity(repositoryClass="App\Repository\Knowledge\ProviderRepository")
 */
class Provider extends AbstractKnowledge implements LocalisableInterface, ReviewableInterface {
	...
	public static $FIELD_DEFS = array(
		Provider::FIELD_SIGN                => array(Provider::ATTRIB_TYPE => Sign::TYPE_STRIPPED_NAME, Provider::ATTRIB_MULTIPLE => false, Provider::ATTRIB_MANDATORY => true, Provider::ATTRIB_CONSTRAINTS => array(array('App\\Validator\\Constraints\\UniqueProvider', array('excludedId' => '@getId'))), Provider::ATTRIB_LINKED_FIELDS => array('brand', 'isAffiliate', 'store')),
		Provider::FIELD_LOGO                => array(Provider::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Provider::ATTRIB_MULTIPLE => false, Provider::ATTRIB_MANDATORY => true, Provider::ATTRIB_QUALITY => \App\Entity\Core\Picture::QUALITY_LD, Provider::ATTRIB_POST_PROCESSOR => \App\Entity\Core\Picture::POST_PROCESSOR_SQUARE),
		...
		Provider::FIELD_WOODS               => array(Provider::ATTRIB_TYPE => Text::TYPE_STRIPPED_NAME, Provider::ATTRIB_MULTIPLE => true, Provider::ATTRIB_FILTER_QUERY => '@woods:"%q%"', Provider::ATTRIB_DATA_CONSTRAINTS => array(array('App\\Validator\\Constraints\\OneThing', array('message' => 'N\'indiquez qu\'une seule essence par proposition.')))),
		Provider::FIELD_BRANCHES  			=> array(Provider::ATTRIB_TYPE => Text::TYPE_STRIPPED_NAME, Provider::ATTRIB_MULTIPLE => true, Provider::ATTRIB_FILTER_QUERY => '@branches:"%q%"', Provider::ATTRIB_DATA_CONSTRAINTS => array(array('App\\Validator\\Constraints\\OneThing', array('message' => 'N\'indiquez qu\'un seul secteur d\'activité par proposition.')))),
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Knowledge\Value\Sign", cascade={"all"})
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Wonder\Creation", mappedBy="providers")
	 */
	private $creations;
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Howto\Howto", mappedBy="providers")
	 */
	private $howtos;
	...
	public function addSignValue(\App\Entity\Knowledge\Value\Sign $signValue) {
	...
	public function removeSignValue(\App\Entity\Knowledge\Value\Sign $signValue) {
	...
	public function addInStoreSellingValue(\App\Entity\Knowledge\Value\Integer $inStoreSellingValue) {
	...
	public function removeInStoreSellingValue(\App\Entity\Knowledge\Value\Integer $inStoreSellingValue) {
	...
	public function addMailOrderSellingValue(\App\Entity\Knowledge\Value\Integer $mailOrderSellingValue) {
	...
	public function removeMailOrderSellingValue(\App\Entity\Knowledge\Value\Integer $mailOrderSellingValue) {
	...
	public function addSaleToIndividualsValue(\App\Entity\Knowledge\Value\Integer $saleToIndividualsValue) {
	...
	public function removeSaleToIndividualsValue(\App\Entity\Knowledge\Value\Integer $saleToIndividualsValue) {
	...
	public function addProductsValue(\App\Entity\Knowledge\Value\Integer $productsValue) {
	...
	public function removeProductsValue(\App\Entity\Knowledge\Value\Integer $productsValue) {
	...
	public function addServicesValue(\App\Entity\Knowledge\Value\Integer $servicesValue) {
	...
	public function removeServicesValue(\App\Entity\Knowledge\Value\Integer $servicesValue) {
	...
	public function addWoodsValue(\App\Entity\Knowledge\Value\Text $woodsValue) {
	...
	public function removeWoodsValue(\App\Entity\Knowledge\Value\Text $woodsValue) {
	...
	public function addStateValue(\App\Entity\Knowledge\Value\Integer $stateValue) {
	...
	public function removeStateValue(\App\Entity\Knowledge\Value\Integer $stateValue) {
	...
	public function addBranchesValue(\App\Entity\Knowledge\Value\Text $branchesValue) {
	...
	public function removeBranchesValue(\App\Entity\Knowledge\Value\Text $branchesValue) {
