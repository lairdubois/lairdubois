...
use App\Entity\Knowledge\Value\Isbn;

/**
 * App\Entity\Knowledge\Book
 *
 * @ORM\Table("tbl_knowledge2_book")
 * @ORM\Entity(repositoryClass="App\Repository\Knowledge\BookRepository")
 */
class Book extends AbstractKnowledge implements ReviewableInterface {
	...
	public static $FIELD_DEFS = array(
		Book::FIELD_IDENTITY      => array(Book::ATTRIB_TYPE => BookIdentity::TYPE_STRIPPED_NAME, Book::ATTRIB_MULTIPLE => false, Book::ATTRIB_MANDATORY => true, Book::ATTRIB_CONSTRAINTS => array(array('App\\Validator\\Constraints\\UniqueBook', array('excludedId' => '@getId'))), Software::ATTRIB_LINKED_FIELDS => array('work', 'isVolume', 'volume')),
		Book::FIELD_COVER         => array(Book::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Book::ATTRIB_MULTIPLE => false, Book::ATTRIB_MANDATORY => true, Book::ATTRIB_POST_PROCESSOR => \App\Entity\Core\Picture::POST_PROCESSOR_SQUARE),
		Book::FIELD_BACK_COVER    => array(Book::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Book::ATTRIB_MULTIPLE => false, Book::ATTRIB_POST_PROCESSOR => \App\Entity\Core\Picture::POST_PROCESSOR_SQUARE),
		Book::FIELD_AUTHORS       => array(Book::ATTRIB_TYPE => Text::TYPE_STRIPPED_NAME, Book::ATTRIB_MULTIPLE => true, Book::ATTRIB_FILTER_QUERY => '@authors:"%q%"', Book::ATTRIB_DATA_CONSTRAINTS => array(array('App\\Validator\\Constraints\\OneThing', array('message' => 'N\'indiquez qu\'un seul auteur par proposition.')))),
		...
		Book::FIELD_SUBJECTS      => array(Book::ATTRIB_TYPE => Text::TYPE_STRIPPED_NAME, Book::ATTRIB_MULTIPLE => true, Book::ATTRIB_FILTER_QUERY => '@subjects:"%q%"', Book::ATTRIB_DATA_CONSTRAINTS => array(array('App\\Validator\\Constraints\\OneThing', array('message' => 'N\'indiquez qu\'un seul sujet par proposition.')))),
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Knowledge\Value\BookIdentity", cascade={"all"})
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Knowledge\Value\Isbn", cascade={"all"})
	...
	/**
	 * @ORM\ManyToMany(targetEntity="App\Entity\Knowledge\Value\Price", cascade={"all"})
	...
	public function addIdentityValue(\App\Entity\Knowledge\Value\BookIdentity $identityValue) {
	...
	public function removeIdentityValue(\App\Entity\Knowledge\Value\BookIdentity $identityValue) {
	...
	public function addCoverValue(\App\Entity\Knowledge\Value\Picture $coverValue) {
	...
	public function removeCoverValue(\App\Entity\Knowledge\Value\Picture $coverValue) {
	...
	public function addBackCoverValue(\App\Entity\Knowledge\Value\Picture $backCoverValue) {
	...
	public function removeBackCoverValue(\App\Entity\Knowledge\Value\Picture $backCoverValue) {
	...
	public function addEditorValue(\App\Entity\Knowledge\Value\Text $editorValue) {
	...
	public function removeEditorValue(\App\Entity\Knowledge\Value\Text $editorValue) {
	...
	public function addSummaryValue(\App\Entity\Knowledge\Value\Longtext $summaryValue) {
	...
	public function removeSummaryValue(\App\Entity\Knowledge\Value\Longtext $summaryValue) {
	...
	public function addTocValue(\App\Entity\Knowledge\Value\Longtext $tocValue) {
	...
	public function removeTocValue(\App\Entity\Knowledge\Value\Longtext $tocValue) {
	...
	public function addSubjectsValue(\App\Entity\Knowledge\Value\Text $subjectsValue) {
	...
	public function removeSubjectsValue(\App\Entity\Knowledge\Value\Text $subjectsValue) {
	...
	public function addCollectionValue(\App\Entity\Knowledge\Value\Text $collectionValue) {
	...
	public function removeCollectionValue(\App\Entity\Knowledge\Value\Text $collectionValue) {
	...
	public function addLanguageValue(\App\Entity\Knowledge\Value\Language $languageValue) {
	...
	public function removeLanguageValue(\App\Entity\Knowledge\Value\Language $languageValue) {
	...
	public function addTranslatedValue(\App\Entity\Knowledge\Value\Integer $translatedValue) {
	...
	public function removeTranslatedValue(\App\Entity\Knowledge\Value\Integer $translatedValue) {
	...
	public function addPageCountValue(\App\Entity\Knowledge\Value\Integer $pageCountValue) {
	...
	public function removePageCountValue(\App\Entity\Knowledge\Value\Integer $pageCountValue) {
	...
	public function addIsbnValue(\App\Entity\Knowledge\Value\Isbn $isbnValue) {
	...
	public function removeIsbnValue(\App\Entity\Knowledge\Value\Isbn $isbnValue) {
	...
	public function addPublishYearValue(\App\Entity\Knowledge\Value\Integer $publishYearValue) {
	...
	public function removePublishYearValue(\App\Entity\Knowledge\Value\Integer $publishYearValue) {
	...
	public function addPublicDomainValue(\App\Entity\Knowledge\Value\Integer $publicDomainValue) {
	...
	public function removePublicDomainValue(\App\Entity\Knowledge\Value\Integer $publicDomainValue) {
	...
	public function addCatalogLinkValue(\App\Entity\Knowledge\Value\Url $catalogLinkValue) {
	...
	public function removeCatalogLinkValue(\App\Entity\Knowledge\Value\Url $catalogLinkValue) {
	...
	public function addPriceValue(\App\Entity\Knowledge\Value\Price $priceValue) {
	...
	public function removePriceValue(\App\Entity\Knowledge\Value\Price $priceValue) {
