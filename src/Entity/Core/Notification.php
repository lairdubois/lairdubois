 ...
 * })
 * @ORM\Entity(repositoryClass="App\Repository\Core\NotificationRepository")
...
class Notification {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="App\Entity\Core\Activity\AbstractActivity", inversedBy="notifications")
	 * @ORM\JoinColumn(nullable=false)
	 */
	private $activity;
	...
	/**
	 * @ORM\ManyToOne(targetEntity="App\Entity\Core\Notification", inversedBy="children")
	 * @ORM\JoinColumn(nullable=true)
	 */
	private $folder;

	/**
	 * @ORM\OneToMany(targetEntity="App\Entity\Core\Notification", mappedBy="folder")
	 * @ORM\OrderBy({"id" = "DESC"})
	 */
	private $children;
	...
	public function setActivity(\App\Entity\Core\Activity\AbstractActivity $activity) {
