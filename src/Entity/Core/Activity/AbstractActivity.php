 ...
 * @ORM\Entity(repositoryClass="App\Repository\Core\Activity\ActivityRepository")
 * @ORM\InheritanceType("JOINED")
 * @ORM\DiscriminatorColumn(name="discr", type="integer")
 * @ORM\DiscriminatorMap({1 = "Comment", 2 = "Follow", 3 = "Like", 4 = "Publish", 5 = "Vote", 6 = "Write", 7 = "Contribute", 8 = "Mention", 9 = "Join", 10 = "Answer", 11 = "Testify", 12 = "Review", 13 = "Feedback", 14 = "Invite", 15 = "Request"})
 */
abstract class AbstractActivity {
	...
	/**
	 * @ORM\OneToMany(targetEntity="App\Entity\Core\Notification", mappedBy="activity", cascade={"remove"})
	 */
