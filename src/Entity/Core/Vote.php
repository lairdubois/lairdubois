 ...
 *		})
 * @ORM\Entity(repositoryClass="App\Repository\Core\VoteRepository")
 */
class Vote implements AuthoredInterface {
	...
	/**
	 * @ORM\OneToOne(targetEntity="App\Entity\Core\Comment")
	...
	public function setComment(\App\Entity\Core\Comment $comment = null) {
