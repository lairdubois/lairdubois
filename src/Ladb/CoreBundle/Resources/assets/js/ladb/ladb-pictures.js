function pictureGalleryUpdateForm(formSection) {
...
function pictureGalleryRemovePicture(formSection, id) {
    $("#picture_" + id).remove();
    pictureGalleryUpdateForm(formSection);
}

function pictureGalleryRemoveAllPictures(formSection) {
    $("#" + formSection + "_thumbnails li").remove(".ladb-picture");
    pictureGalleryUpdateForm(formSection);
}

function pictureGalleryEditPicture(formSection, id, url) {
    jQuery.ajax(url, {
        cache: false,
        dataType: "html",
...
function pictureGalleryCancelEditPicture(formSection, id) {
    var modal = $("#edit_" + formSection + "_" + id + "_modal");
    modal.modal("hide");
    modal.remove();
}

function pictureGalleryRotatePreview(preview, input, angle) {
...
function pictureGalleryInit(options) {
