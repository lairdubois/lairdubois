...
class Wood extends AbstractKnowledge {
	...
	public static $FIELD_DEFS = array(
		...
		Wood::FIELD_GRAIN          => array(Wood::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => false, Wood::ATTRIB_MANDATORY => true, Wood::ATTRIB_QUALITY => \Ladb\CoreBundle\Entity\Core\Picture::QUALITY_HD),
		Wood::FIELD_ENDGRAIN       => array(Wood::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => false, Wood::ATTRIB_QUALITY => \Ladb\CoreBundle\Entity\Core\Picture::QUALITY_HD),
		Wood::FIELD_LUMBER         => array(Wood::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => false, Wood::ATTRIB_QUALITY => \Ladb\CoreBundle\Entity\Core\Picture::QUALITY_HD),
		Wood::FIELD_TREE           => array(Wood::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => false, Wood::ATTRIB_QUALITY => \Ladb\CoreBundle\Entity\Core\Picture::QUALITY_HD),
		Wood::FIELD_LEAF           => array(Wood::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => false, Wood::ATTRIB_QUALITY => \Ladb\CoreBundle\Entity\Core\Picture::QUALITY_HD),
		Wood::FIELD_BARK           => array(Wood::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, Wood::ATTRIB_MULTIPLE => false, Wood::ATTRIB_QUALITY => \Ladb\CoreBundle\Entity\Core\Picture::QUALITY_HD),
