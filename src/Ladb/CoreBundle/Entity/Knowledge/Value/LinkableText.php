 ...
 * @ORM\Entity(repositoryClass="Ladb\CoreBundle\Repository\Knowledge\Value\LinkableTextRepository")
 */
class LinkableText extends Text {

	const CLASS_NAME = 'LadbCoreBundle:Knowledge\Value\LinkableText';
	const TYPE = 23;
