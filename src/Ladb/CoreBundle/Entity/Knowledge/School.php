...
class School extends AbstractKnowledge implements LocalisableInterface {
	...
	public static $FIELD_DEFS = array(
		...
		School::FIELD_LOGO           => array(School::ATTRIB_TYPE => Picture::TYPE_STRIPPED_NAME, School::ATTRIB_MULTIPLE => false, School::ATTRIB_MANDATORY => true, School::ATTRIB_QUALITY => \Ladb\CoreBundle\Entity\Core\Picture::QUALITY_LD, School::ATTRIB_POST_PROCESSOR => \Ladb\CoreBundle\Entity\Core\Picture::POST_PROCESSOR_SQUARE),
