...
class CleanupBlocksCommand extends ContainerAwareCommand {
...
EOT
	...
	protected function execute(InputInterface $input, OutputInterface $output) {
		...
		$queryBuilder
			->select(array( 'b' ))
			->from('LadbCoreBundle:Block\AbstractBlock', 'b')
		;
		...
		$queryBuilder
			->select(array( 'e', 'bb' ))
			->from('LadbCoreBundle:Wonder\Creation', 'e')
		...
		$queryBuilder
			->select(array( 'e', 'bb' ))
			->from('LadbCoreBundle:Wonder\Workshop', 'e')
			->leftJoin('e.bodyBlocks', 'bb')
		;
		...
		$queryBuilder
			->select(array( 'e', 'bb' ))
			->from('LadbCoreBundle:Blog\Post', 'e')
			->leftJoin('e.bodyBlocks', 'bb')
		;
		...
		$queryBuilder
			->select(array( 'e', 'bb' ))
			->from('LadbCoreBundle:Faq\Question', 'e')
			->leftJoin('e.bodyBlocks', 'bb')
		;
		...
		$queryBuilder
			->select(array( 'e', 'bb' ))
			->from('LadbCoreBundle:Howto\Article', 'e')
			->leftJoin('e.bodyBlocks', 'bb')
		;
