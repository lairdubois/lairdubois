...
class UserController extends Controller {
	...
	public function listAction(Request $request, $page = 0, $layout = 'view') {
		...
		$searchParameters = $searchUtils->searchPaginedEntities(
			...
			'fos_elastica.index.ladb.user',
			\Ladb\CoreBundle\Entity\User::CLASS_NAME,
			'core_user_list_page'
		);
		...
		if ($layout == 'geojson') {
			...
			return $this->render('LadbCoreBundle:User:list-xhr.geojson.twig', $parameters);
		}

		if ($request->isXmlHttpRequest()) {
			return $this->render('LadbCoreBundle:User:list-xhr.html.twig', $parameters);
		}
	 ...
	 * @Template("LadbCoreBundle:User:location.geojson.twig")
	 */
	 ...
	 * @Template("LadbCoreBundle:User:card-xhr.html.twig")
	 */
	...
	public function showLikesAction(Request $request, $username, $filter = "sent", $page = 0) {
		...
		if ($request->isXmlHttpRequest()) {
			return $this->render('LadbCoreBundle:Like:list-byuser-xhr.html.twig', $parameters);
		}
	...
	public function showCommentsAction(Request $request, $username, $filter = "recent", $page = 0) {
		...
		if ($request->isXmlHttpRequest()) {
			return $this->render('LadbCoreBundle:Comment:list-byuser-xhr.html.twig', $parameters);
		}
	...
	public function showFollowingAction(Request $request, $username, $filter = "popular-followers", $page = 0) {
		...
		if ($request->isXmlHttpRequest()) {
			return $this->render('LadbCoreBundle:Follower:following-list-xhr.html.twig', $parameters);
		}
	...
	public function showFollowersAction(Request $request, $username, $filter = "popular-followers", $page = 0) {
		...
		if ($request->isXmlHttpRequest()) {
			return $this->render('LadbCoreBundle:Follower:followers-list-xhr.html.twig', $parameters);
		}
	...
	public function showAction($username) {
		...
		if ($user->getPublishedCreationCount() > 0) {
			$forwardController = 'LadbCoreBundle:User:showCreations';
		} else if ($user->getPublishedPlanCount() > 0) {
			$forwardController = 'LadbCoreBundle:User:showPlans';
		} else if ($user->getPublishedHowtoCount() > 0) {
			$forwardController = 'LadbCoreBundle:User:showHowtos';
		} else if ($user->getPublishedWorkshopCount() > 0) {
			$forwardController = 'LadbCoreBundle:User:showWorkshops';
		} else if ($user->getPublishedFindCount() > 0) {
			$forwardController = 'LadbCoreBundle:User:showFinds';
		} else {
			$forwardController = 'LadbCoreBundle:User:showAbout';
		}
	 ...
	 * @Template("LadbCoreBundle:User:showAdmin.html.twig")
	 */
