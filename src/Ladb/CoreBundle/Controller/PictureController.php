...
class PictureController extends Controller {
	 ...
	 * @Template("LadbCoreBundle:Picture:edit-xhr.html.twig")
	 */
	 ...
	 * @Method("POST")
	 * @Template("LadbCoreBundle:Picture:update-error-xhr.html.twig")
	 */
	public function updateAction(Request $request, $id) {
		...
		if ($form->isValid()) {
			...
			return $this->render('LadbCoreBundle:Picture:update-success-xhr.html.twig', array(
				'picture'     => $picture,
				'formSection' => $request->get('formSection', 'pictures'),
				'sortable'    => $request->get('sortable', false),
			));
