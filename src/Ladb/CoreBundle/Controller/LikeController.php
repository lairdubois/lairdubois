...
class LikeController extends Controller {
	 ...
	 * @Template("LadbCoreBundle:Like:create-xhr.html.twig")
	 */
	 ...
	 * @Template("LadbCoreBundle:Like:delete-xhr.html.twig")
	 */
	 ...
	 * @Template("LadbCoreBundle:Like:list-byentity.html.twig")
	 */
	public function listEntityAction(Request $request, $entityType, $entityId, $page = 0) {
		...
		if ($request->isXmlHttpRequest()) {
			return $this->render('LadbCoreBundle:Like:list-byentity-xhr.html.twig', $parameters);
		}
		return $parameters;
	}
