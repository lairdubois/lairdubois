...
class BlogController extends Controller {
	 ...
	 * @Method("POST")
	 * @Template("LadbCoreBundle:Blog:new.html.twig")
	 */
	 ...
	 * @Method("POST")
	 * @Template("LadbCoreBundle:Blog:edit.html.twig")
	 */
	...
	public function listAction(Request $request, $page = 0) {
		...
		if ($request->isXmlHttpRequest()) {
			return $this->render('LadbCoreBundle:Blog:list-xhr.html.twig', $parameters);
		}
	...
	public function showAction(Request $request, $id) {
		...
		$similarPosts = $explorableUtils->getSimilarExplorables($post, 'fos_elastica.index.ladb.post', Post::CLASS_NAME);
