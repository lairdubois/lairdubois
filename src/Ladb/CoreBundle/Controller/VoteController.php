...
class VoteController extends Controller {
	...
	public function createAction(Request $request, $entityType, $entityId, $sign) {
		...
		if ($request->isXmlHttpRequest()) {
			...
			return $this->render('LadbCoreBundle:Vote:create-xhr.html.twig', array(
	...
	public function deleteAction(Request $request, $id) {
		...
		if ($request->isXmlHttpRequest()) {
			...
			return $this->render('LadbCoreBundle:Vote:delete-xhr.html.twig', array(
				'voteContext' => $votableUtils->getVoteContext($entity, $this->getUser()),
			));
		}
	 ...
	 * @Template("LadbCoreBundle:Vote:list-byparent.html.twig")
	 */
	public function showParentVotesAction(Request $request, $entityType, $entityId, $filter = 'positive', $page = 0) {
		...
		if ($request->isXmlHttpRequest()) {
			return $this->render('LadbCoreBundle:Vote:list-byparent-xhr.html.twig', $parameters);
		}
