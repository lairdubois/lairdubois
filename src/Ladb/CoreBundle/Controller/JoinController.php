...
class JoinController extends Controller {
	 ...
	 * @Template("LadbCoreBundle:Join:create-xhr.html.twig")
	 */
	 ...
	 * @Template("LadbCoreBundle:Join:delete-xhr.html.twig")
	 */
	 ...
	 * @Template("LadbCoreBundle:Join:list-byentity.html.twig")
	 */
	public function listEntityAction(Request $request, $entityType, $entityId, $page = 0) {
		...
		if ($request->isXmlHttpRequest()) {
			return $this->render('LadbCoreBundle:Join:list-byentity-xhr.html.twig', $parameters);
		}
		return $parameters;
	}
