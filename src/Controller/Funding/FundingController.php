...
use App\Entity\Funding\Charge;
use App\Entity\Core\User;
use App\Entity\Funding\Donation;
use App\Entity\Funding\Funding;
use App\Form\Type\Funding\ChargeType;
use App\Manager\Funding\FundingManager;
...
class FundingController extends AbstractController {
	 ...
	 */
	public function donationConfirmed(Request $request) {
		if (!$request->isXmlHttpRequest()) {
