...
class OpencutlistController extends AbstractController {
	 ...
	 */
	public function manifest(Request $request, $env = 'prod') {
	 ...
	 */
	public function download(Request $request, $env = 'prod') {
	 ...
	 */
	public function tutorials(Request $request, $env = 'prod') {
	 ...
	 */
	public function docs(Request $request, $env = 'prod') {
	...
	public function stats(Request $request, $page = 0) {
		...
		if ($request->isXmlHttpRequest()) {
			return $this->render('Opencutlist:list-xhr.html.twig', $parameters);
		}
